...
export function EditorSettingsPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="fixed top-14 right-6 z-[50] w-[280px] bg-[#0A0A0A]/95 backdrop-blur-xl border border-[#262626] p-4 text-[#FAFAFA] font-sans select-none animate-in fade-in zoom-in-95 duration-150"
    >
      {/* Top Header */}
