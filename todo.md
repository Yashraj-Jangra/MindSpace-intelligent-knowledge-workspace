...
- [x] Built **Ultra-Advanced Classic Note Editor Suite**:
  ...
  - **Table Column Options 2nd Click Popover (`AdvancedNoteEditor.tsx`)**: Clicking on table controls or selecting a table node reveals a 2nd-click **Column Options** dropdown allowing instant addition/deletion of columns (left/right), rows (above/below), and table removal.
